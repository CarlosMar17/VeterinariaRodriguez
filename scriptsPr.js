...
let servicios = [
    { id: 1, nombre: 'Shampoo', proveedores: ['Shampoo', 'Acondicionador'], descripcion: 'El servicio incluye el baño de la mascota y peinado.', precio: 20, servicios: 20 },
    { id: 2, nombre: 'Corte de Pelo', proveedores: ['Tijeras', 'Peine'], descripcion: 'Descripción del corte de pelo.', precio: 30, servicios: 15 },
    { id: 3, nombre: 'Vacunación', proveedores: ['Vacuna', 'Jeringa'], descripcion: 'Descripción de la vacunación.', precio: 50, servicios: 10 },
                ...
                <div class="details" id="details_${servicio.id}">
                    ...
                    <table class="details-table">
                        ...
                        <tr>
                            <td>
                                <ul>
                                    ${servicio.proveedores.map(product => `<li>${product}</li>`).join('')}
                                </ul>
                            </td>
                            ...
                            <td>
                            <ul>
                                ${servicio.servicio.map(servicio => `<li>${servicio}</li>`).join('')}
                            </ul>
                            </td>
                        </tr>
                    </table>
...
function editService(id, event) {
    ...
    document.getElementById('productListModal').value = service.proveedores.join(', ');
    ...
    document.getElementById('serviceAppointmentsModal').value = service.servicios;
